...
import styles from './TableGeneralLab.module.scss';
...
const TableGeneralLab: React.FC = () => {
  ...
  return (
    <div className={styles.container}>
      <Flex gap={12} style={{ padding: 4 }}>
        <div>Tubes to be collected: 5</div>
        <div>
          Collected tubes:: <span style={{ color: '#FF4D4F' }}>2</span>
        </div>
      </Flex>
      <Table
...
export default TableGeneralLab;
